...
export default async function OperatorDashboard() {
  ...
  const [{count:pendingCount},{count:jobsToday},{count:equipmentCount},{data:recent}] = await Promise.all([
