    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto">
        ...
        <p className="text-xl text-slate-400 mb-10 leading-relaxed">
          Real-time scheduling, live bin tracking, and route optimization for jobsite equipment rentals.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/quotes" className="btn-primary text-lg px-8 py-3 rounded-xl">Get a Quote</Link>
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm text-slate-400">
          {['Live Bin Tracking', 'Swap Planning', 'Lead Capture'].map(feature => (
