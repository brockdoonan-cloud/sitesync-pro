...
const translations: Record<Language, Dictionary> = {
  en: {
    ...
    requestSubmittedConfirmed: 'Your quote request was submitted successfully. Providers in your service area can now review it.',
    confirmationSentTo: 'We sent your confirmation and tracking link to',
    smsConfirmationCopy: 'If SMS is available, we also sent it to your phone.',
    saveTrackingLinkCopy: 'Save this page or email link to compare responses.',
  ...
  es: {
    ...
    requestSubmittedConfirmed: 'Tu solicitud de cotizaci\u00f3n fue enviada correctamente. Los proveedores de tu zona ya pueden revisarla.',
    confirmationSentTo: 'Enviamos tu confirmaci\u00f3n y enlace de seguimiento a',
    smsConfirmationCopy: 'Si SMS est\u00e1 disponible, tambi\u00e9n lo enviamos a tu tel\u00e9fono.',
    saveTrackingLinkCopy: 'Guarda esta p\u00e1gina o el enlace del correo para comparar respuestas.',
    ...
    routesShort: 'Rutas',
    mapShort: 'Mapa',
    equipmentShort: 'Equipo',
    trucksShort: 'Camiones',
...
const exactSpanishPhrases: Record<string, string> = {
  ...
  'Tracking Setup': 'Configurar rastreo',
  'Connect GPS Provider': 'Conectar proveedor GPS',
  'Truck GPS Provider Onboarding': 'Carga de proveedor GPS de camiones',
  'Connect any fleet tracking company by mapping its vehicle feed into SiteSync truck locations.': 'Conecta cualquier compa\u00f1\u00eda de rastreo mapeando su feed de veh\u00edculos a las ubicaciones de camiones en SiteSync.',
  'Back to trucks': 'Volver a camiones',
  'Route Board': 'Tablero de rutas',
  '1. Pick the tracking company': '1. Elige la compa\u00f1\u00eda de rastreo',
  'Use a preset for common vendors, or choose custom for any other GPS/ELD provider.': 'Usa una plantilla para proveedores comunes o elige personalizado para cualquier proveedor GPS/ELD.',
  'Provider company name': 'Nombre de proveedor',
  'API base URL, optional': 'URL base de API, opcional',
  'External account / fleet ID, optional': 'Cuenta externa / ID de flota, opcional',
  'Auth type': 'Tipo de autenticaci\u00f3n',
  'Credential reference, not the secret itself': 'Referencia de credencial, no el secreto',
  'Provider notes, sync schedule, contact, or setup instructions': 'Notas del proveedor, horario de sincronizaci\u00f3n, contacto o instrucciones',
  'Save Tracking Provider': 'Guardar proveedor de rastreo',
  'Saving...': 'Guardando...',
  'Saved providers': 'Proveedores guardados',
  'Each provider can feed live GPS by webhook, API job, or CSV upload.': 'Cada proveedor puede enviar GPS en vivo por webhook, tarea API o carga CSV.',
  'No providers saved yet.': 'Todav\u00eda no hay proveedores guardados.',
  'not synced yet': 'sin sincronizar',
  '2. Map provider fields to SiteSync': '2. Mapea campos del proveedor a SiteSync',
  'Each field accepts one or more possible paths separated by commas. SiteSync tries them in order.': 'Cada campo acepta una o m\u00e1s rutas separadas por comas. SiteSync las prueba en orden.',
  '3. Test import GPS rows': '3. Prueba importar filas GPS',
  'Paste CSV, TSV, JSON object, or JSON array from any provider. Imported rows update trucks and write location history.': 'Pega CSV, TSV, objeto JSON o arreglo JSON de cualquier proveedor. Las filas importadas actualizan camiones y guardan historial de ubicaci\u00f3n.',
  'Import GPS Rows': 'Importar filas GPS',
  'Importing...': 'Importando...',
  'parsed row(s)': 'fila(s) procesadas',
  '4. Webhook for live GPS': '4. Webhook para GPS en vivo',
  'For providers that can post JSON, copy this URL into their webhook destination. It normalizes payloads using the field map above.': 'Para proveedores que pueden enviar JSON, copia esta URL en su destino de webhook. Normaliza los datos usando el mapa de campos.',
  'Webhook URL': 'URL de webhook',
  'Copy Webhook URL': 'Copiar URL de webhook',
  'Save or select a provider to generate its webhook URL.': 'Guarda o selecciona un proveedor para generar su URL de webhook.',
  'Preview rows': 'Vista previa de filas',
  'No preview rows yet.': 'Todav\u00eda no hay filas de vista previa.',
  'Any GPS vendor': 'Cualquier proveedor GPS',
  'Other / Custom Provider': 'Otro / proveedor personalizado',
  'Fleet telematics': 'Telem\u00e1tica de flota',
  'Fleet tracking': 'Rastreo de flota',
  'ELD / fleet tracking': 'ELD / rastreo de flota',
  'Use Tracking Setup to onboard Samsara, Geotab, Verizon Connect, Motive, Azuga, or any other GPS provider.': 'Usa Configurar rastreo para cargar Samsara, Geotab, Verizon Connect, Motive, Azuga o cualquier otro proveedor GPS.',
}
