...
const translations: Record<Language, Dictionary> = {
  en: {
    ...
    choosePortalSubtitle: 'Choose the portal you need, then sign in.',
    operatorPortal: 'Operator Portal',
    operatorPortalDesc: 'Manage dispatch, maps, equipment, billing, leads, and routes.',
    operatorLoginHelper: 'For Atlantic staff, operators, dispatch, billing, drivers, and admins.',
    customerPortalDesc: 'Request swaps, follow live tracking, view bins, and review invoices.',
    customerLoginHelper: 'For customers who need to request service or see project billing.',
    customerAccessNote: 'Customer portal access is connected to the account your operator set up for your company.',
    ...
    requestSwapForBin: 'Request swap for bin',
    swapRequested: 'Swap Requested',
    activeSwapRequest: 'Active swap request',
    submitSwapRequest: 'Submit Swap Request',
    swapDateTimeRequired: 'Please choose a preferred date and time.',
    cancel: 'Cancel',
  ...
  es: {
    ...
    choosePortalSubtitle: 'Elige el portal que necesitas y luego inicia sesi\u00f3n.',
    operatorPortal: 'Portal del operador',
    operatorPortalDesc: 'Administra despacho, mapas, equipo, facturaci\u00f3n, clientes y rutas.',
    operatorLoginHelper: 'Para personal de Atlantic, operadores, despacho, facturaci\u00f3n, conductores y administradores.',
    customerPortalDesc: 'Solicita cambios, sigue el rastreo en vivo, ve contenedores y revisa facturas.',
    customerLoginHelper: 'Para clientes que necesitan solicitar servicio o ver facturaci\u00f3n del proyecto.',
    customerAccessNote: 'El acceso al portal del cliente est\u00e1 conectado a la cuenta que tu operador configur\u00f3 para tu empresa.',
    ...
    requestSwapForBin: 'Solicitar cambio para contenedor',
    swapRequested: 'Cambio solicitado',
    activeSwapRequest: 'Solicitud de cambio activa',
    submitSwapRequest: 'Enviar solicitud de cambio',
    swapDateTimeRequired: 'Por favor elige una fecha y hora preferida.',
    cancel: 'Cancelar',
...
const exactSpanishPhrases: Record<string, string> = {
  ...
  'Five-day demo daily reports': 'Reportes diarios demo de cinco d\u00edas',
  'Loaded from the Orlando report workbook for fast audit/demo review.': 'Cargados desde el libro de reportes de Orlando para revisi\u00f3n r\u00e1pida de auditor\u00eda/demo.',
  ...
  'Daily Operations Report for': 'Reporte diario de operaciones para',
  'Drop / Delivery': 'Entrega',
  'Pickup': 'Recogida',
  'Water Removal': 'Retiro de agua',
  'Relocate': 'Reubicar',
  'Drops': 'Entregas',
  'Pickups': 'Recogidas',
  'Water': 'Agua',
  ...
  'Save Daily Report': 'Guardar reporte diario',
