...
drop index if exists public.billing_events_org_event_date_idx;
drop index if exists public.billing_events_org_bin_idx;
drop index if exists public.billing_events_org_invoice_number_idx;
